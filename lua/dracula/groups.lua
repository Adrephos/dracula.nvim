...
local function setup(configs)
   ...
   return {
      ...
      Identifier = { fg = colors.bright_cyan, italic = true, },
      Function = { fg = colors.cyan },
      Statement = { fg = colors.purple, italic = true, },
      ...
      Type = { fg = colors.green, bold = true, italic = true, },
      StorageClass = { fg = colors.pink, },
      Structure = { fg = colors.yellow, },
      TypeDef = { fg = colors.yellow, },
      Special = { fg = colors.bright_yellow, italic = true, },
